...
\begin{flalign*}
    ...
    &=\sum_{n\in[k]}A_{i_1,n}B_{i_2,n}\sum_{j_3\in[m]}C_{j_3,n}[a]_{j_3}\\
    &=\left[ADiag(C^T a)B^T\right]_{i_1,i_2}.
\end{flalign*} Since the above is true for every $i_1,i_2$, we get the desired equality.
